    ...
    <Box className="parent" bg="#04293a" id="aboutme">
      <Box className="content-about" padding={25}>
        ...
        >
          ...
          product that user like to use and improve the user interactions and
          familiar to user.
        </Text>
        <Text
          fontSize={{ base: "12px", md: "16px", lg: "18px" }}
          ...
          fontWeight={500}
        >
           Quick learner and aspiring
          Full-Stack Web Devloper with core knowledge of MERN stack techonology.
          Looking forword to applying and enhancing my skills and knowledge as a
          developre.
        </Text>
      </Box>
